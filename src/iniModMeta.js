...
export * from './heroExpandDom.js'
import {
  RS_BYPASS_TOGGLE_SVG,
  SVG_HERO_MOD_TOGGLE_DOWN,
  SVG_HERO_MOD_TOGGLE_UP,
  SVG_MOD_CHIP_MAGIC_STAR,
  SVG_MOD_CHIP_SUM_DOWN,
  SVG_MOD_CHIP_SUM_UP,
  SVG_MOD_CHIP_UNFAEHIG_MARK,
  TP_TZ_BRIDGE_SVG,
  createLeThresholdGaugeBox,
  mountSlot9Placeholder,
  mountZoneMiniWappen,
