...
const SVG_FA_BOLT = `<svg class="init-fa-cell__bolt-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 28" aria-hidden="true"><ellipse cx="9" cy="14" rx="4.4" ry="11.6" fill="#2d1454" opacity="0.42"/><path fill="#12082a" d="M9 0.8 Q11.2 8 12.4 14 Q11.2 20 9 27.2 Q6.8 20 5.6 14 Q6.8 8 9 0.8 Z"/><path fill="#4a148c" d="M9 3.4 Q10.6 8.7 11.6 14 Q10.6 19.3 9 24.6 Q7.4 19.3 6.4 14 Q7.4 8.7 9 3.4 Z"/><path fill="#5e35b1" d="M9 6.6 Q9.7 10.3 10.05 14 Q9.7 17.7 9 21.4 Q8.3 17.7 7.95 14 Q8.3 10.3 9 6.6 Z"/><path fill="#9575cd" opacity="0.38" d="M7.1 4.2 Q7.55 9.8 7.75 14 Q7.55 18.2 7.1 23.8 Q6.65 18.2 6.45 14 Q6.65 9.8 7.1 4.2 Z"/><path fill="#ede7f6" opacity="0.55" d="M8.15 7.4 Q8.45 10.8 8.55 14 Q8.45 17.2 8.15 20.6 Q7.85 17.2 7.75 14 Q7.85 10.8 8.15 7.4 Z"/><path fill="none" stroke="#311b92" stroke-width="0.5" stroke-linejoin="round" d="M9 0.8 Q11.2 8 12.4 14 Q11.2 20 9 27.2 Q6.8 20 5.6 14 Q6.8 8 9 0.8 Z"/></svg>`
...
/** UO (Umwandel-Objekt): blaues Schild mit weißem Pfeil nach rechts (≠ Speicher-Schild). */
const SVG_UO_CONVERT_SHIELD = `<span class="init-kr-uo-convert-icon" aria-hidden="true"><svg class="init-kr-abw-shield__svg init-kr-abw-shield__svg--uo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 34" aria-hidden="true"><path fill="#5d4037" d="M12 2l8 3v8.4c0 6.9-3.2 13-8 15.8-4.8-2.8-8-8.9-8-15.8V5l8-3z"/><path fill="#1a237e" d="M12 4.25 6 6.45v7.1c0 5.4 2.45 10.3 6 12.7 3.55-2.4 6-7.3 6-12.7v-7.1L12 4.25z"/><path fill="#3949ab" d="M12 5.55 7.15 7.25v6.45c0 4.2 1.85 8.1 4.85 10.2 3-2.1 4.85-6 4.85-10.2V7.25L12 5.55z"/><path fill="#b8860b" d="M12 2.75 19.05 4.85 18.85 5.45 12 3.75 5.15 5.45 4.95 4.85 12 2.75z"/><path fill="#90caf9" opacity="0.4" d="M8.65 9.1c1.05 2.5 1.55 5.15 1.55 7.95 0 3.45-.75 6.75-2.1 9.75 1.85-1.7 3.05-4.55 3.05-7.75 0-3.25-.85-6.3-2.5-8.95z"/><path fill="none" stroke="#3e2723" stroke-width="0.45" d="M12 4.25 6 6.45v7.1c0 5.4 2.45 10.3 6 12.7 3.55-2.4 6-7.3 6-12.7v-7.1L12 4.25z"/><path class="init-kr-uo-convert-arrow" fill="#fff" stroke="#1a237e" stroke-width="0.55" stroke-linecap="round" stroke-linejoin="round" d="M13.2 17h6.1M17.8 17l-2.6-2.6M17.8 17l-2.6 2.6"/></svg></span>`
