      ...
      if (entry.kind === 'token') {
        ...
        if (canEdit) {
          ...
          expandBtn.title = isGmSync()
            ? 'Zeile aufklappen: Zeile 1 (AT … AE … MR IB −BE+W6 INI), Zeile 2 (KF … RB WS LE/max), Zeile 3 (MU … KK, KO+TP/TZ); links (i) und SL-Zahnrad'
            : 'Zeile aufklappen: Zeile 1 (AT … AE … MR IB −BE+W6 INI), Zeile 2 (KF … RB WS LE/max), Zeile 3 (MU … KK, KO+TP/TZ); links (i) und Zahnrad (Zeilenfarbe)'
