      ...
      if (entry.kind === 'token') {
        ...
        if (canEdit) {
          ...
          expandBtn.title = isGmSync()
            ? 'Zeile aufklappen: Zeile 1 (AT PA AW TP GS IB BE W6 FK KE AE AU LE … MOD), Zeile 2 (KF … RB WS MAX), Zeile 3 (MU … KK, KO+TP/TZ); links (i) und SL-Zahnrad'
            : 'Zeile aufklappen: Zeile 1 (AT PA AW TP GS IB BE W6 FK KE AE AU LE … MOD), Zeile 2 (KF … RB WS MAX), Zeile 3 (MU … KK, KO+TP/TZ); links (i) und Zahnrad (Zeilenfarbe)'
