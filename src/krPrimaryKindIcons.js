...
// Geometrie um ~+1.5 in Y abgesenkt (etwas tiefer platziert). Neck/Engstelle bei
// (12, 16.5); obere Kammer y7.5..16.5, untere Kammer y16.5..25.5.
export const SVG_PRIMARY_LH_STAR = `<svg class="init-kr-primary-kind__svg init-kr-primary-kind__svg--lh" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 34" aria-hidden="true"><path fill="#fffdf5" opacity="0.22" d="M6 7.5 H18 L12 16.5 Z M6 25.5 H18 L12 16.5 Z"/><path fill="currentColor" d="M7 8.7 H17 L12.8 14.5 H11.2 Z"/><path fill="currentColor" d="M11.7 14.5 H12.3 V24.9 H11.7 Z"/><path fill="currentColor" d="M7 25.3 H17 L12 19.3 Z"/><path fill="none" stroke="#5d4037" stroke-width="0.8" stroke-linejoin="round" d="M6 7.5 H18 L12 16.5 L18 25.5 H6 L12 16.5 Z"/><path fill="#b8860b" d="M4.8 6.1 H19.2 V7.5 H4.8 Z M4.8 25.5 H19.2 V26.9 H4.8 Z"/><path fill="none" stroke="#3e2723" stroke-width="0.45" stroke-linejoin="round" d="M4.8 6.1 H19.2 V7.5 H4.8 Z M4.8 25.5 H19.2 V26.9 H4.8 Z"/></svg>`
...
export const SVG_LH_FRAME = `<svg class="init-kr-primary-lh-hg__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 34" aria-hidden="true"><path fill="#fffdf5" opacity="0.22" d="M6 7.5 H18 L12 16.5 Z M6 25.5 H18 L12 16.5 Z"/><path fill="none" stroke="#5d4037" stroke-width="0.8" stroke-linejoin="round" d="M6 7.5 H18 L12 16.5 L18 25.5 H6 L12 16.5 Z"/><path fill="#b8860b" d="M4.8 6.1 H19.2 V7.5 H4.8 Z M4.8 25.5 H19.2 V26.9 H4.8 Z"/><path fill="none" stroke="#3e2723" stroke-width="0.45" stroke-linejoin="round" d="M4.8 6.1 H19.2 V7.5 H4.8 Z M4.8 25.5 H19.2 V26.9 H4.8 Z"/></svg>`
...
export const SVG_LH_SAND_TOP = `<svg class="init-kr-primary-kind__svg init-kr-primary-kind__svg--lh" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 34" aria-hidden="true"><path fill="currentColor" d="M6 7.5 H18 L12 16.5 Z"/></svg>`

// Untere Kammer-Sand; CSS-Maske zeigt die untere frac-Portion (fuellt vom Boden).
export const SVG_LH_SAND_BOTTOM = `<svg class="init-kr-primary-kind__svg init-kr-primary-kind__svg--lh" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 34" aria-hidden="true"><path fill="currentColor" d="M6 25.5 H18 L12 16.5 Z"/></svg>`

// Duenner rieselnder Sandstrahl an der Engstelle (Heldenfarbe via currentColor).
export const SVG_LH_STREAM = `<svg class="init-kr-primary-kind__svg init-kr-primary-kind__svg--lh" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 34" aria-hidden="true"><rect x="11.7" y="16.5" width="0.6" height="8" fill="currentColor"/></svg>`
