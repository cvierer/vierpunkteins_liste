...
export const SVG_PRIMARY_LH_STAR = `<svg class="init-kr-primary-kind__svg init-kr-primary-kind__svg--lh" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 34" aria-hidden="true"><path fill="#fffdf5" opacity="0.22" d="M6 6 H18 L12 15 Z M6 24 H18 L12 15 Z"/><path fill="currentColor" d="M7 7.2 H17 L12.8 13 H11.2 Z"/><path fill="currentColor" d="M11.7 13 H12.3 V23.4 H11.7 Z"/><path fill="currentColor" d="M7 23.8 H17 L12 17.8 Z"/><path fill="none" stroke="#5d4037" stroke-width="0.8" stroke-linejoin="round" d="M6 6 H18 L12 15 L18 24 H6 L12 15 Z"/><path fill="#b8860b" d="M4.8 4.6 H19.2 V6 H4.8 Z M4.8 24 H19.2 V25.4 H4.8 Z"/><path fill="none" stroke="#3e2723" stroke-width="0.45" stroke-linejoin="round" d="M4.8 4.6 H19.2 V6 H4.8 Z M4.8 24 H19.2 V25.4 H4.8 Z"/></svg>`
