...
export const SVG_PRIMARY_LH_STAR = `<svg class="init-kr-primary-kind__svg init-kr-primary-kind__svg--lh" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 34" aria-hidden="true"><path fill="#5d4037" d="M12 5l3.35 6.95 7.55.55-5.75 4.95 1.8 7.4L12 21.05 5.05 24.85l1.8-7.4L1.1 12.5l7.55-.55z"/><path fill="currentColor" opacity="0.55" d="M12 6.45 14.85 12.4l6.55.5-4.95 4.25 1.55 6.45L12 20.2 5.95 23.6l1.55-6.45L2.6 12.9l6.55-.5z"/><path fill="currentColor" opacity="0.8" d="M12 8 14.45 13l5.65.45-4.3 3.7 1.35 5.55L12 19.5l-5.15 3.2 1.35-5.55-4.3-3.7 5.65-.45z"/><path fill="currentColor" d="M12 9.65 13.95 13.7l4.6.35-3.55 3.05 1.1 4.55L12 19l-4.1 2.6 1.1-4.55-3.55-3.05 4.6-.35z"/><path fill="#fffde7" d="M10.9 13.35 H13.1 L12 14.95 Z M10.9 16.55 H13.1 L12 14.95 Z"/><path fill="none" stroke="#b8860b" stroke-width="0.55" stroke-linejoin="round" stroke-linecap="round" d="M10.9 13.35 H13.1 L12 14.95 L13.1 16.55 H10.9 L12 14.95 Z"/><path fill="none" stroke="#b8860b" stroke-width="0.7" stroke-linecap="round" d="M10.7 13.2 H13.3 M10.7 16.7 H13.3"/><path fill="none" stroke="#3e2723" stroke-width="0.45" stroke-linejoin="round" d="M12 5l3.35 6.95 7.55.55-5.75 4.95 1.8 7.4L12 21.05 5.05 24.85l1.8-7.4L1.1 12.5l7.55-.55z"/></svg>`
